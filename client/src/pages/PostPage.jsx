...
import CommnetSetion from '../Components/CommnetSetion';
...
export default function PostPage() {
  ...
  return (
    <div className=' p-3 flex flex-col max-w-full mx-auto min-h-screen mt-[70px]'>
      ...
      {<CommnetSetion postId={post._id} />}

      <div className='flex flex-col justify-center items-center mb-5 max-w-full'>
