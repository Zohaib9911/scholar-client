...
export default function DashComponent() {
  ...
  const [totalLastMonthUsers, setLastMonthUsers] = useState(0);
  ...
  return (
    <div className=' p-3 md:mx-auto'>
      <div className=' flex flex-wrap gap-4 justify-center'>
        {/* 1st div */}
        <div className=' flex flex-col p-3d dark:bg-slate-800 gap-4md md:w-72 w-full rounded-md shadow-md'>
